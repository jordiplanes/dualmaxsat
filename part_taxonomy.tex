...
treating the SAT solver as a conflict generator that provides \emph{all}
necessary constraints to the dual. Because the hitting-set master is integer
...
this way, IHS is a **Row Generation** algorithm on the hitting-set formulation.
Its dual is a **Column Generation** algorithm where each column represents an
MSS. This mirrors the Dantzig--Wolfe decomposition of Section 2, but where the
