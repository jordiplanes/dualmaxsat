...
of \cref{sec:part3}. (iii) Cross-family warm-starting---using a short
core-guided phase to seed an IHS master, or vice versa---remains untested
both theoretically and empirically and is the cheapest of the predicted
hybrid techniques to deploy.
