...
\begin{itemize}
\item \textbf{$P_4$ (worked example, \cref{sec:example}):} 4 unit soft clauses
...
returned cost, the final LP master value, the number of outer iterations,
SAT-oracle calls, IP-master solves, and Pareto refinements (additional
in-search SAT calls). The warm-start seed is a 5-iteration core-guided
(Fu--Malik) phase, harvested via \texttt{coreguided.harvest\_cores}.
...
toy instances shipped in \texttt{src/wcnf/}. Columns: \textit{Cost} (returned
optimum), \textit{LP} (final LP-master value), \textit{It} (outer iterations),
\textit{SAT} (SAT-oracle calls), \textit{IP} (IP-master solves), \textit{Pr}
(Pareto refinements). Warm-start uses a 5-iteration Fu--Malik seed.}
\label{tab:results}
\resizebox{\textwidth}{!}{%
\begin{tabular}{l cccccc cccccc cccccc}
\toprule
& \multicolumn{6}{c}{\textbf{$P_4$ (worked)}}
& \multicolumn{6}{c}{\textbf{$K_3$ (counter)}}
& \multicolumn{6}{c}{\textbf{Weighted Chain}} \\
\cmidrule(lr){2-7} \cmidrule(lr){8-13} \cmidrule(lr){14-19}
\textbf{Config.}
& Cost & LP & It & SAT & IP & Pr
& Cost & LP & It & SAT & IP & Pr
& Cost & LP & It & SAT & IP & Pr \\
\midrule
Plain IHS (baseline)         & 2 & 2.0 & 3 & 3 & 3 & 0  & 2 & 1.5 & 4 & 4 & 4 & 0  & 13 & 13.0 & 7 & 7  & 7 & 0 \\
+ Warm-start (Fu--Malik seed)& 2 & 2.0 & 1 & 1 & 1 & 0  & 2 & 1.5 & 2 & 2 & 2 & 0  & 13 & 13.0 & 2 & 2  & 2 & 0 \\
+ Pareto core selection      & 2 & 2.0 & 3 & 4 & 3 & 0  & 2 & 1.5 & 4 & 6 & 4 & 0  & 13 & 13.0 & 7 & 19 & 7 & 0 \\
+ Wentges ($\alpha_0{=}1$, $\rho{=}0.5$)
                              & 2 & 2.0 & 3 & 3 & 3 & 0  & 2 & 1.5 & 4 & 4 & 4 & 0  & 13 & 13.0 & 7 & 7  & 7 & 0 \\
+ In-out separation ($\lambda{=}0.5$)
                              & 2 & 2.0 & 3 & 5 & 3 & 0  & 2 & 1.5 & 4 & 7 & 4 & 0  & 13 & 13.0 & 7 & 13 & 7 & 0 \\
+ Price-aware ordering       & 2 & 2.0 & 3 & 3 & 3 & 0  & 2 & 1.5 & 4 & 4 & 4 & 0  & 13 & 13.0 & 7 & 7  & 7 & 0 \\
\textsc{Hybrid} (all)        & 2 & 2.0 & 1 & 1 & 1 & 0  & 2 & 1.5 & 2 & 4 & 2 & 0  & 13 & 13.0 & 2 & 8  & 2 & 0 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\item \textbf{Stabilization techniques are inactive at this scale.} Wentges and
price-aware ordering produce numerically identical runs to the baseline, and
