...
\bibitem[Fu and Malik(2006)]{fu2006solving}
Z.~Fu and S.~Malik.
\newblock On solving the partial {MAX-SAT} problem.
\newblock In \emph{Proc.\ SAT 2006}, LNCS 4121, pages 252--265. Springer, 2006.

\bibitem[Marques-Silva and Planes(2008)]{marquessilva2008algorithms}
J.~Marques-Silva and J.~Planes.
\newblock Algorithms for maximum satisfiability using unsatisfiable cores.
\newblock In \emph{Proc.\ Design, Automation and Test in Europe (DATE 2008)},
  pages 408--413. IEEE, 2008.
\newblock doi: 10.1109/DATE.2008.4484715.
...
\bibitem[Ben-Ameur and Neto(2007)]{benameur2007stabilization}
W.~Ben-Ameur and J.~Neto.
\newblock Acceleration of cutting-plane and column generation algorithms:
  Applications to network design.
\newblock \emph{Networks}, 49(1):3--17, 2007.
...
\bibitem[Magnanti and Wong(1981)]{magnanti1981accelerating}
T.L.~Magnanti and R.T.~Wong.
\newblock Accelerating {B}enders decomposition: Algorithmic enhancement and
  model selection criteria.
\newblock \emph{Operations Research}, 29(3):464--484, 1981.
...
\bibitem[Wentges(1997)]{wentges1997weighted}
P.~Wentges.
\newblock Weighted {D}antzig--{W}olfe decomposition for linear mixed-integer
  programming.
