...
DW \textbf{terminates with value $\boldsymbol{3/2}$}. This result is confirmed
empirically by the \texttt{IHSSolver} in \texttt{src/ihs.py}: on a 3-clause
WCNF encoding of $K_3$, the final LP master value is exactly $1.5$.
